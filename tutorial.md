...
This tool helps you link a billing account and spin up a Cloud SQL for PostgreSQL instance (with all required API dependencies) using your active Google Cloud credentials.
